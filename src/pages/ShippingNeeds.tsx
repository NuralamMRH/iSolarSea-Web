            ...
            <div key={section} className="mb-12">
              <div className="border-t border-sea-300 pt-4 mb-4">
                <h3 className="text-lg font-semibold text-sea-700">
                  Khu vực {section}: Quảng Nam đến Bình Định
                </h3>
              </div>
                  ...
                  <TableBody>
                    {[1, 2].map((row) => (
                      <TableRow key={row}>
                        ...
                        <TableCell>Hội An</TableCell>
                        <TableCell>Quy Nhơn</TableCell>
                        <TableCell>1,800 kg</TableCell>
                        <TableCell>05/25/2025</TableCell>
                        <TableCell>9,500,000đ</TableCell>
                        <TableCell>
