    ...
    <Card className={cn("overflow-hidden", className)}>
      <CardHeader className="pb-3 flex flex-row items-center">
        <div className="flex items-center">
          ...
          <h3 className="font-semibold text-lg">FISHING LOG PER HAUL</h3>
        </div>
      </CardHeader>
          ...
          {news.map((item) => (
            ...
            >
              <div className="flex justify-between items-start mb-2">
                <h4 className="font-medium text-base text-[16px]">
                  {item.title}
                </h4>
              ...
              {item.imageUrl && (
                <div className="relative h-64 mb-3 overflow-hidden rounded-md">
                  <img
                    src={item.imageUrl}
                    alt={item.title}
